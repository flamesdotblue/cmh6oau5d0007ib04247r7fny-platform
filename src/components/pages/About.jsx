        ...
        <div className="grid lg:grid-cols-12 gap-10 items-center">
          ...
          >
            ...
            <p className="mt-4 text-gray-600">
              We believe in timeless design, responsible sourcing, and products that make daily life a little more special. Each piece is crafted with longevity in mind.
            </p>
