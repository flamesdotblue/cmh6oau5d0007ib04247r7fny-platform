      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="hidden md:flex items-center gap-4">
            ...
            <button className="relative inline-flex items-center justify-center rounded-full h-10 w-10 border border-gray-200 hover:border-teal-300 hover:text-teal-600 transition-colors">
          ...
          <div className="md:hidden flex items-center gap-3">
            <button aria-label="Cart" className="relative inline-flex items-center justify-center rounded-full h-10 w-10 border border-gray-200">
              <ShoppingCart className="h-5 w-5" />
            </button>
            ...
            <nav className="flex flex-col gap-4">
              {navItems.map((item) => (
                <a
                  ...
                  className="text-base text-gray-700 hover:text-teal-600"
                >
                  {item.label}
                </a>
              ))}
