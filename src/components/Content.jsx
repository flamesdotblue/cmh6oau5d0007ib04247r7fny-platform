...
const products = [
  {
    ...
    price: 48,
    image:
      'https://images.unsplash.com/photo-1593030761757-71fae1f9f0a8?q=80&w=1200&auto=format&fit=crop',
  },
  {
    name: 'Stoneware Mug',
    price: 24,
  ...
  },
  {
    ...
    price: 32,
    image:
      'https://images.unsplash.com/photo-1610701592029-1d82fa7d42fe?q=80&w=1200&auto=format&fit=crop',
  },
  {
    name: 'Scented Candle',
    price: 18,
  ...
  },
  {
    ...
    price: 26,
    image:
      'https://images.unsplash.com/photo-1467043153537-a4f1fbc3eac5?q=80&w=1200&auto=format&fit=crop',
  },
];
...
const testimonials = [
  {
    name: 'Sophia L.',
    quote:
      'Beautifully made pieces. The attention to detail and packaging were superb. Will definitely shop again!',
    rating: 5,
  },
  {
    name: 'Daniel K.',
    quote:
      'Clean design and great quality. The products feel premium without the pretension.',
    rating: 5,
  },
  {
    name: 'Maya P.',
    quote:
      'Customer service was responsive and helpful. My new everyday favorites.',
    rating: 4,
  },
];
      ...
      <section id="categories" className="py-14 sm:py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-end justify-between gap-4 mb-8">
            ...
            <a href="#products" className="hidden sm:inline-flex text-teal-700 hover:text-teal-800 font-medium">View all</a>
          </div>
      ...
      <section id="products" className="py-14 sm:py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-end justify-between gap-4 mb-8">
            ...
            <a href="#" className="hidden sm:inline-flex text-teal-700 hover:text-teal-800 font-medium">Browse all</a>
          </div>
          ...
          <div className="grid lg:grid-cols-12 gap-10 items-center">
            ...
            >
              ...
              <p className="mt-4 text-gray-600">
                We believe in timeless design, responsible sourcing, and products that make daily life a little more special. Each piece is crafted with longevity in mind, so you can buy less and enjoy more.
              </p>
              <p className="mt-3 text-gray-600">
                From sustainable materials to ethical partnerships, our commitment to quality extends beyond the product itself.
              </p>
